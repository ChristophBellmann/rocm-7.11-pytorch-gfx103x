...
# The rocm-core package was only introduced in ROCm 6.4, so we make it optional.
  ...
  if(USE_ROCM_HIPBLASLT)
    find_package_and_print_version(hipblaslt)
    if(NOT hipblaslt_FOUND)
      message(WARNING "hipblaslt requested but not found; disabling USE_ROCM_HIPBLASLT")
      set(USE_ROCM_HIPBLASLT OFF)
    endif()
  else()
    message(STATUS "hipblaslt disabled via USE_ROCM_HIPBLASLT=OFF")
  endif()
  ...
  if(UNIX)
    ...
    if(USE_ROCM_HIPBLASLT AND hipblaslt_FOUND AND ROCM_VERSION_DEV VERSION_GREATER_EQUAL "5.7.0")
